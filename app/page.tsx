  ...
  if (modo === "inicio") {
    return (
      <main style={{ minHeight: "100vh", background: "#0f172a", display: "flex", justifyContent: "center", alignItems: "center", padding: 20 }}>
        ...
        <aside style={{ position: "fixed", left: 14, bottom: 14, width: "min(245px, calc(100vw - 28px))", background: "white", color: "#0f172a", borderRadius: 18, overflow: "hidden", boxShadow: "0 22px 55px rgba(2,6,23,.32)", zIndex: 20, textAlign: "left" }}>
